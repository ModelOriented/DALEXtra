...
* Skip `explain_keras` and `explain_scikitlearn` examples why running on macOS as the can rise false-positive errors during R CMD check for some versions of macOS. The very same code still executes properly in tests.
